...
namespace PERSONEL_TAKİP_OTOMASyonu
{
    public partial class frmMesailer : Form
    {
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            string sql = "update Mesailer set PersonelID='"+p.PERSONELID+"',AdiSoyadi='"+m.AdiSoyadi+"',baslangicsaati='"+m.Baslangic_Saati+"',bitissaati='"+m.Bitis_Saati+"'," +
